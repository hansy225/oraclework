...
SELECT ENAME, EXTRACT(MONTH FROM HIREDATE) 입사월
FROM EMP
WHERE EXTRACT(MONTH FROM HIREDATE) = '9';

-- 14. EMP테이블에서 81년도에 입사한 직원 조회
SELECT ENAME, EXTRACT(YEAR FROM HIREDATE) 입사년도
FROM EMP
...
SELECT EMPNO, ENAME, HIREDATE 입사일, ADD_MONTHS(HIREDATE, 480) "입사일로부터 40년되는 날짜"
FROM EMP;
